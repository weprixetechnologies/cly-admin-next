    ...
    const fetchOrders = async (page = 1) => {
        try {
            ...
            if (data.success === false) {
                console.error('[RejectedOrders] API error:', data.message, data.error);
                setOrders([]);
            ...
            console.error('[RejectedOrders] Request failed:', e);
        } finally {
            setIsLoading(false);
        }
    };
        ...
        <div className="min-h-screen">
            <header className="bg-white shadow-sm border-b">
                <div className="px-4 sm:px-6 py-4">
                    <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Rejected Orders</h1>
                </div>
            </header>
            ...
            <main className="p-4 sm:p-6">
                <div className="bg-white rounded-lg shadow p-6">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-lg font-medium text-gray-900">Rejected Orders</h2>
